...
/*支付跳转*/
export const Payment = (orderId, money, title, receiverId, callBackUrl = location.href) => {
  const receiver = receiverId || '21dc2f8e-6e57-4eb5-afbb-a6910157dc21'
  ...
  window.location.href = url + '?businessTypeCode=56&orderId=' +
    ...
    '&tradeMoney=' + money + '&receiverId=' + receiver +
    '&userId=' + GetUserID() +
